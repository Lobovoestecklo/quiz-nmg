...
export async function POST(request: Request) {
  ...
  try {
    ...
    const messageParts = [
      ...
      {
        type: 'text',
        text: `Сценарий ${title} успешно создан. Что бы вы хотели сделать дальше? Пожалуйста, опишите ваш запрос в диалоговом окне и нажмите "Отправить" (или "Enter"), чтобы продолжить работу.`,
      },
    ];
