...
1. **Тип вопроса:**  
   ...
   - multiple_choice_text — Множественный выбор
...
3. **Формат вывода таблицы:**
   - Используй **точку с запятой `;
` как разделитель между столбцами**.
...
2. По одному примеру каждого типа вопроса в формате итоговой таблицы:
ID;Название секции;Баллы;Тип вопроса;Рекомендации;Случайный порядок;Текст вопроса;Картинка;Вариант 1;Вариант 2;...
...
- Правильные ответы ВСЕГДА начинаются со звездочки (*), если применимо
