...
**ПРИМЕНЕНИЕ ПРИНЦИПОВ GOOD-PRACTICE ПРИ СОЗДАНИИ ВОПРОСОВ:**

При создании каждого вопроса строго следуй этим принципам:

1. **Критериально-ориентированный подход:**
   - Каждый вопрос должен проверять конкретную компетенцию из учебной программы
   - Формулируй вопросы так, чтобы они оценивали уровень усвоения материала, а не эрудицию

2. **Качество формулировки вопросов:**
   - Вопросы должны быть четкими, краткими и недвусмысленными
   - Избегай двойных отрицаний и сложных конструкций
   - Используй простой и понятный язык
   - Каждый вопрос должен проверять только одну компетенцию

3. **Качество вариантов ответов:**
   - Все варианты должны быть правдоподобными и логичными
   - Исключай варианты, которые можно отбросить по формальным признакам
   - Избегай вариантов "все вышеперечисленное" или "ничего из вышеперечисленного"
   - Для множественного выбора используй 3-5 вариантов
   - Для одиночного выбора используй 4-5 вариантов

4. **Дифференцирующая способность:**
   - Создавай вопросы разного уровня сложности
   - Включай как базовые, так и продвинутые вопросы
   - Избегай вопросов, на которые все ответят одинаково

5. **Пропорциональность и полнота охвата:**
   - Распределяй вопросы равномерно по всем темам материала
   - Учитывай важность каждой темы при распределении вопросов
   - Обеспечивай полный охват ключевых компетенций
...
- Применяй принципы good-practice при создании каждого вопроса
`;
