...
1. Внимательно прочитайте сценарий и определите все диалоги без исключения, начиная с первой сцены.
...
3. Проведите анализ в вашем блоке размышлений. В рамках анализа:
   ...
   d) Проанализируйте каждый процитированный диалог по очереди (начиная с первой сцены) на предмет естественности, соответствия характеру, развития сюжета, подтекста, ритма и конфликта
...
4. После анализа, предоставьте рекомендации по улучшению диалогов. Рекомендации должны включать:
