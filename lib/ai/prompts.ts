...
3. При обнаружении нарушений:
   ...
   - При ссылке на правила из Памятки для Окко ОБЯЗАТЕЛЬНО добавляйте ссылку на документ: https://drive.google.com/file/d/16n5B7c3Vr1Ikxo0GfrzN4mBorIDextX4/view?usp=sharing
...
- При каждом упоминании правил из Памятки для Окко ОБЯЗАТЕЛЬНО добавляйте ссылку на документ: https://drive.google.com/file/d/16n5B7c3Vr1Ikxo0GfrzN4mBorIDextX4/view?usp=sharing

// Структура отчёта о нарушениях:
// Для каждого нарушения указывайте:
// - Местоположение в тексте (номер сцены)
// - Точную дословную цитату
// - Нарушенное правило с источником (для Памятки для Окко - с обязательной ссылкой на документ)
