      ...
      <div className="rounded-xl p-6 flex flex-col gap-6 leading-relaxed text-center max-w-2xl">
        <div className="space-y-4">
          ...
          <p className="text-muted-foreground">
            Напишите "Привет" или "Здравствуйте" — и я сразу начну задавать вопросы, 
            чтобы подобрать идеальные курсы для ваших целей!
          </p>
        </div>
        ...
        <div className="bg-green-50 dark:bg-green-950/20 rounded-lg p-4 space-y-2 text-left">
          ...
          <p className="text-sm text-green-600 dark:text-green-400">
            Просто напишите любое приветствие — "Привет", "Здравствуйте" или "Добрый день" — 
            и я сразу начну консультацию с вопроса о ваших целях развития!
          </p>
        </div>
      </div>
    </motion.div>
